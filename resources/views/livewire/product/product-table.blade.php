<div class="flex flex-col">
              ...
              <th scope="col" class="px-6 py-3 text-left">
                <div class="flex items-center">
                  <button wire:click="sortBy('name')"
                    class="text-xs font-medium text-gray-500 uppercase tracking-wider focus:outline-none">Name</button>
          ...
          <tbody>
            ...
            <tr x-data="{{ json_encode(['even' => $loop->even]) }}" :class="{'bg-gray-50': even }">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                ...
                <button type="button" wire:click="confirmDelete({{ $product }})"
  ...
  <x-jet-confirmation-modal wire:model="confirmingDelete">
    ...
    <x-slot name="content">
      {{ __('Are you sure you would like to delete this Product?') }}
    </x-slot>
