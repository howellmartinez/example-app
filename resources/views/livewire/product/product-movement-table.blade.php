      ...
      <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
        <table class="min-w-full divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              <th scope="col" class="w-1 px-6 py-3 text-left">
                <div class="flex items-center">
                  <button wire:click="sortBy('id')"
                    class="text-xs font-medium text-gray-500 uppercase tracking-wider focus:outline-none">ID</button>
              ...
              <th scope="col"
                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider focus:outline-none">
                Ref
              </th>
              <th scope="col"
                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider focus:outline-none">
          ...
          <tbody>
            ...
            <tr x-data="{{ json_encode(['even' => $loop->even]) }}" :class="{'bg-gray-50': even }">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                {{ $movement->inventoriable->getInventoryRefNo() }}
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <a href="{{ $movement->inventoriable->getInventoryUri() }}">
                  <button type="button"
