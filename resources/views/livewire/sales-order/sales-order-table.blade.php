<div class="flex flex-col">
          ...
          <tbody>
            ...
            <tr x-data="{{ json_encode(['even' => $loop->even]) }}" :class="{'bg-gray-50': even }">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <a href="/sales-orders/{{ $salesOrder->id }}">
                  <button type="button"
                ...
                <a href="/sales-orders/{{ $salesOrder->id }}/edit">
                  <button type="button"
                ...
                <button type="button" wire:click="confirmDelete({{ $salesOrder }})"
  ...
  <x-jet-confirmation-modal wire:model="confirmingDelete">
    ...
    <x-slot name="content">
      {{ __('Are you sure you would like to delete this Sales Order?') }}
    </x-slot>
