  ...
  <div class="mt-4">
    ...
    <div class="hidden sm:block">
      <nav class="-mb-px flex space-x-8"
        ...
        <a href="/customers/{{ $customer->id }}" :class="{{$active}}=='overview' ? active : inactive" class="whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">
          Overview
        </a>

        <a href="/customers/{{ $customer->id }}/edit" :class="{{$active}}=='profile' ? active : inactive" class="whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">
          Profile
        </a>
      </nav>
    </div>
